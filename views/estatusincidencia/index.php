...
/* @var $searchModel app\models\EstatusincidenciaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Estatusincidencias');
...
$nuevo=$exportar='';
    if(Helper::checkRoute('create')){
       $nuevo = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/estatusincidencia/create'],
                ['role'=>'modal-remote','title'=> 'Nuevo Estatusincidencias','class'=>'btn btn-default']);
    }
...
?>
<div class="estatusincidencia-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-estatusincidencia',
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Listado de Estatusincidencias',
