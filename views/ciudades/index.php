...
$nuevo=$exportar='';
    if(Helper::checkRoute('create')){
       $nuevo = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/ciudades/create'],
                ['role'=>'modal-remote','title'=> 'Nuevo Ciudades','class'=>'btn btn-default']);
    }
...
<div class="ciudades-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Listado de Ciudades',
