...
$nuevo=$exportar='';
    if(Helper::checkRoute('create')){
       $nuevo = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/categoriaincidencia/create'],
                ['role'=>'modal-remote','title'=> 'Nuevo Categoriaincidencias','class'=>'btn btn-default']);
    }
...
?>
<div class="categoriaincidencia-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-categoriaincidencia',
