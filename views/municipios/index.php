...
$nuevo=$exportar='';
    if(Helper::checkRoute('create')){
       $nuevo = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/municipios/create'],
                ['role'=>'modal-remote','title'=> 'Nuevo Municipios','class'=>'btn btn-default']);
    }
...
<div class="municipios-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Listado de Municipios',
