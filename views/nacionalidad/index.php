...
/* @var $searchModel app\models\NacionalidadSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Nacionalidads');
...
$nuevo=$exportar='';
    if(Helper::checkRoute('create')){
       $nuevo = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/nacionalidad/create'],
                ['role'=>'modal-remote','title'=> 'Nuevo Nacionalidads','class'=>'btn btn-default']);
    }
...
?>
<div class="nacionalidad-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-nacionalidad',
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Listado de Nacionalidads',
