...
$this->title = Yii::t('app', 'Parroquias');
...
$nuevo=$exportar='';
    if(Helper::checkRoute('create')){
       $nuevo = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/parroquias/create'],
                ['role'=>'modal-remote','title'=> 'Nuevo Parroquias','class'=>'btn btn-default']);
    }
...
<div class="parroquias-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Listado de Parroquias',
