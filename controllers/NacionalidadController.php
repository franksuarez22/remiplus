...
use app\models\NacionalidadSearch;
...
class NacionalidadController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'#crud-datatable-nacionalidad-pjax',
                    'title'=> "Nacionalidad",
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_nacionalidad]);
            } else {
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#crud-datatable-nacionalidad-pjax'];
        }else{
            /*
            *   Process for non-ajax request
            */
     ...
     /**
     * Delete multiple existing Nacionalidad model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
