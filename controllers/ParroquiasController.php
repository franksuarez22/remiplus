...
class ParroquiasController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'#crud-datatable-parroquias-pjax',
                    'title'=> "Parroquias",
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_parroquia]);
            } else {
    ...
    /**
     * Delete an existing Parroquias model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#crud-datatable-parroquias-pjax'];
        }else{
            /*
            *   Process for non-ajax request
            */
     ...
     /**
     * Delete multiple existing Parroquias model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function actionParroquias() {
        ...
        if (isset($_POST['depdrop_parents'])) {
            ...
            if ($id_municipio != null) {         
                $data= Parroquias::find()
                ->where(['id_municipio'=>$id_municipio])
                ->select(['id_parroquia as id','parroquia AS name'])->asArray()->all();
