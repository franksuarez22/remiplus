...
class CiudadesController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'#crud-datatable-ciudades-pjax',
                    'title'=> "Ciudades",
    ...
    /**
     * Delete an existing Ciudades model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#crud-datatable-ciudades-pjax'];
        }else{
            /*
            *   Process for non-ajax request
            */
     ...
     /**
     * Delete multiple existing Ciudades model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function actionCiudades() {
        ...
        if (isset($_POST['depdrop_parents'])) {
            ...
            $id_parroquia = $parents[0];
            if ($id_parroquia != null) {         
                $data= Ciudades::find()
                ->where(['id_parroquia'=>$id_parroquia])
                ->select(['id_ciudad as id','ciudad AS name'])->asArray()->all();
