...
class GeneroSearch extends Genero
{
    ...
    {
        return [
            [['id_genero', 'usuario_creador', 'usuario_modificador'], 'integer'],
            [['descripcion_genero', 'ip_log', 'fecha_creacion', 'fecha_modificacion'], 'safe'],
            [['estatus'], 'boolean'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'descripcion_genero', $this->descripcion_genero])
